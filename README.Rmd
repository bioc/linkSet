...
gr2 <- GRanges(seqnames = c("chr1", "chr2", "chr2"),
              ...
              strand = "+")
## construct linkSet
linkSetExample <- linkSet(gr1, gr2, specificCol = "symbol")
linkSetExample


```

The full manual can be reached at [Documentation](https://gilberthan1011.github.io/linkSet/articles/linkSet.html).
```{r out.width = '80%', echo = FALSE, fig.alt="Overview diagram of the linkSet methods"}
knitr::include_graphics("vignettes/img/linksetmethod.png")
```
