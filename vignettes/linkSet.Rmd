...
Of course, you can also calculate the distance between the bait and oe region.
```{r}
linkExample = linkSet::pairdist(linkExample)
```
The annotated distance is shown in distance column.
## Annotations
